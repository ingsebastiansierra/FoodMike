...
import { resetOnboarding } from '../../features/core/utils/onboarding';
...
const ProfileScreen = () => {
  ...
  const userData = {
    name: profile?.full_name || user?.user_metadata?.full_name || 'Usuario TOC TOC',
    email: profile?.email || user?.email || 'usuario@toctoc.com',
              ...
              <View style={styles.profileSection}>
                ...
                <View style={styles.userInfo}>
                  <Text style={styles.userName}>
                    TOC TOC de {profile?.full_name || user?.user_metadata?.full_name || 'Usuario'}
                  </Text>
